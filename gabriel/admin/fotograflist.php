...
?>
<p><span class="phpmaker">TABLE: fotograf
</span></p>
<table class="ewListAdd">
	<tr>
		<td><span class="phpmaker"><a href="fotografadd.php">Add</a></span></td>
	</tr>
</table>
<p>
<?php
...
<table id="ewlistmain" class="ewTable">
	...
	<tr class="ewTableHeader">
		<td valign="top"><span>
	<a href="fotograflist.php?order=<?php echo urlencode("isim"); ?>">
	isim<?php if (@$_SESSION[ewSessionTblSort . "_x_isim"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION[ewSessionTblSort . "_x_isim"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
		...
		<td valign="top"><span>
	<a href="fotograflist.php?order=<?php echo urlencode("seri"); ?>">
	seri<?php if (@$_SESSION[ewSessionTblSort . "_x_seri"] == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION[ewSessionTblSort . "_x_seri"] == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?>
	</a>
		</span></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<td><span class="phpmaker"><a href="<?php if ($x_id <> "") {echo "fotografview.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">View</a></span></td>
<td><span class="phpmaker"><a href="<?php if ($x_id <> "") {echo "fotografedit.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Edit</a></span></td>
<td><span class="phpmaker"><a href="<?php if ($x_id <> "") {echo "fotografadd.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Copy</a></span></td>
<td><span class="phpmaker"><a href="<?php if ($x_id <> "") {echo "fotografdelete.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Delete</a></span></td>
	</tr>
<?php
	}
}
...
?>
<form action="fotograflist.php" name="ewpagerform" id="ewpagerform">
<table>
	<tr>
		<td nowrap>
<?php
...
<!--first page button-->
	...
	<?php } else { ?>
	<td><a href="fotograflist.php?start=1"><img src="images/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($PrevStart == $nStartRec) { ?>
	<td><img src="images/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="fotograflist.php?start=<?php echo $PrevStart; ?>"><img src="images/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	...
	<?php } else { ?>
	<td><a href="fotograflist.php?start=<?php echo $NextStart; ?>"><img src="images/next.gif" alt="Next" width="16" height="16" border="0"></a></td>
	<?php  } ?>
<!--last page button-->
	<?php if ($LastStart == $nStartRec) { ?>
	<td><img src="images/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } else { ?>
	<td><a href="fotograflist.php?start=<?php echo $LastStart; ?>"><img src="images/last.gif" alt="Last" width="16" height="16" border="0"></a></td>
	<?php } ?>
...
function SetUpSortOrder()
{
	...
	if (strlen(@$_GET["order"]) > 0) {
		...
		if ($sOrder == "seri") {
			$sSortField = "`seri`";
			$sLastSort = @$_SESSION[ewSessionTblSort . "_x_seri"];
			$sThisSort = ($sLastSort == "ASC") ? "DESC" : "ASC";
			$_SESSION[ewSessionTblSort . "_x_seri"] = $sThisSort;
		} else {
			if (@$_SESSION[ewSessionTblSort . "_x_seri"] <> "") { @$_SESSION[ewSessionTblSort . "_x_seri"] = ""; }
		}
