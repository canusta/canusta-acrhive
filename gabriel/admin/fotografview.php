...
<p><span class="phpmaker">View TABLE: fotograf<br><br>
<a href="fotograflist.php">Back to List</a>&nbsp;
<a href="<?php if ($x_id <> "") {echo "fotografedit.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Edit</a>&nbsp;
<a href="<?php if ($x_id <> "") {echo "fotografadd.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Copy</a>&nbsp;
<a href="<?php if ($x_id <> "") {echo "fotografdelete.php?id=" . urlencode($x_id); } else { echo "javascript:alert('Invalid Record! Key is null');";} ?>">Delete</a>&nbsp;
</span></p>
<p>
<form>
<table class="ewTable">
...
<?php echo $x_id; ?>
	...
	<tr>
		<td class="ewTableHeader"><span>isim</span></td>
		<td class="ewTableAltRow"><span>
...
<?php } ?>
	...
	<tr>
		<td class="ewTableHeader"><span>fullview</span></td>
		<td class="ewTableAltRow"><span>
<?php if ((!is_null($x_fullview)) &&  $x_fullview <> "") { ?>
<img src="<?php echo ewUploadPathEx(False, EW_UploadDestPath) . $x_fullview ?>" border=0>
<?php } ?>
</span></td>
	</tr>
	<tr>
