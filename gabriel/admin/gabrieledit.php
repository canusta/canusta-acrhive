...
if (($x_id == "") || (is_null($x_id))) {
	ob_end_clean();
	header("Location: gabriellist.php");
	exit();
}
...
<p><span class="phpmaker">Edit TABLE: gabriel<br><br><a href="gabriellist.php">Back to List</a></span></p>
<form name="fgabrieledit" id="fgabrieledit" action="gabrieledit.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<input type="text" name="x_isim" id="x_isim" size="30" maxlength="100" value="<?php echo htmlspecialchars(@$x_isim) ?>">
</span></td>
		</tr>
		<tr id="r_metin">
			<td class="ewTableHeader"><span>metin<span class='ewmsg'>&nbsp;*</span></span></td>
			<td class="ewTableAltRow"><span id="cb_x_metin">
<input type="text" name="x_metin" id="x_metin" size="30" maxlength="250" value="<?php echo htmlspecialchars(@$x_metin) ?>">
</span></td>
		</tr>
		<tr id="r_orders">
